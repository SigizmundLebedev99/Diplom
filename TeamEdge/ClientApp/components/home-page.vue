<template>
    <div>
        ...
        <ul>
            <li><a href="https://get.asp.net/"><v-icon>edit</v-icon> ASP.NET Core</a> and <a href="https://msdn.microsoft.com/en-us/library/67ef8sbd.aspx">C#</a>                    for cross-platform server-side code</li>
            <li><a href="https://vuejs.org/"><v-icon>edit</v-icon> Vue.js</a> for client-side code</li>
            ...
            <li><a href="https://fontawesome.com"><v-icon>edit</v-icon> Font Awesome</a> (Free) for the icons</li>
        ...
        <p><a href="mailto:hello@devhelp.online"><v-icon>edit</v-icon> Hello@DevHelp.Online</a></p>
    </div>
</template>
