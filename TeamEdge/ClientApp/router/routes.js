...
import dashboard from '../components/on-project/dashboard/dashboard'
import Backlog from '../components/on-project/backlog/backlog'
...
export const routes = [
  ...
  },
  {
    ...
    children:[
      ...
      {
        name:'EPIC', path:'epic-:number', component: WorkItem, beforeEnter:ifAuthenticated
      },
      {
