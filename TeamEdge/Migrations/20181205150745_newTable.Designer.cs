...
namespace TeamEdge.Migrations
{
    ...
    [Migration("20181205150745_newTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.BranchLink", b =>
                {
                    ...
                    b.Property<int?>("WorkItemDescriptionId");

                    b.HasKey("Id");

                    b.HasIndex("CreatorId");

                    b.HasIndex("WorkItemDescriptionId");
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Repository", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Task", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.UserStory", b =>
                {
                    ...
                    b.Property<string>("AcceptenceCriteriaJson");
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.BranchLink", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.WorkItemDescription")
                        .WithMany("CodeLinks")
                        .HasForeignKey("WorkItemDescriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Project", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.Repository", "Repository")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Subscribe", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.WorkItemDescription", "WorkItemDescription")
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Task", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.Task")
                        .WithMany("Children")
