...
namespace TeamEdge.Migrations
{
    ...
    [Migration("20190512085905_renameEpic")]
    partial class renameEpic
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models._Task", b =>
                {
                    ...
                    b.Property<int?>("EpicDescriptionId");
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Epic", b =>
                {
                    b.Property<int>("DescriptionId");
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Timesheet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models._Task", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.Epic", "Epic")
                        .WithMany("Links")
                        .HasForeignKey("EpicDescriptionId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.Timesheet", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models._Task", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("TeamEdge.DAL.Models.UserStory", b =>
                {
                    ...
                    b.HasOne("TeamEdge.DAL.Models.Epic", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
